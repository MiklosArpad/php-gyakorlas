...
if (isset($_POST['email'])) {
    ...
    if ($res && $res->num_rows == 1) {
        ...
        $row = $res->fetch_assoc();
        //print_r($row); //tesztelési céllal kiírtuk a felhasználó adatbázisban tárolt adatait
...
if (isset($_SESSION['error'])) {
    echo "<h2>{$_SESSION['error']}</h2>"; //Az error kulcs létezése esetén kiírjuk a tárolt hibaüzenetet.
}
?>

<body style="background-image: url('imges/img_1614-1.jpg');

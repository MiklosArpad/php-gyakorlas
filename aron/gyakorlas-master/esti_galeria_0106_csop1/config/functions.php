...
function printMenu() {
    ...
    if (isLogged()) {
        ...
        $menu = str_replace('::ki_belepes', '<li class="nav-item">  <a class="nav-link text-light" href="upload.php">Feltöltés</a> </li>'.'<li class="nav-item">  <a class="nav-link text-light" href="logout.php">Kilép</a> </li>', $menu);
    } else {
